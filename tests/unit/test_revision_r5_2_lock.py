...
_HOA_CASES = (
    ("ATC A0", 10.6607177397636, 0.042843228031728, -0.049768591452183, 1.1403719218599668, 3.873044280533011),
    ("ATC B0", 10.7994608127046, 0.042796627074844, -0.049904251031978, 1.1321586892047213, 3.862022848532071),
    ("ATC C0", 11.9319042729257, 0.042448113245389, -0.051112914597138, 1.085573754456201, 3.749213495625393),
    ("ATC N0", 13.0868466098400, 0.042142604666272, -0.052561201642766, 1.1157631293787236, 3.9702160240822932),
    ("LB A0", 9.82075967655328, 0.043146386119843, -0.048999851666158, 1.1955480642618987, 3.929074252012369),
    ("LB B0", 9.93700387280114, 0.043102143275457, -0.049101025920726, 1.1875264175099327, 3.9223303269731855),
    ("LB C0", 10.8857065066950, 0.042768119191440, -0.049989874959669, 1.127241338816112, 3.854893595069231),
    ("LB N0", 11.8419087661532, 0.042473892850381, -0.051009815103168, 1.0873771748874406, 3.759845588531939),
)
...
def _hoa_mechanism_percent(radius_mm: float) -> tuple[float, float]:
    ...
    mono_sag, _ = binary4_piecewise_sag_mm(radii, spec.radial_apertures_mm, _mono_zones(radius_mm))
